...
namespace MQTTnet.Client
{
    public class MqttClient : IMqttClient
    {
        ...
        public MqttClient(IMqttClientAdapterFactory channelFactory, IMqttNetLogger logger)
        {
            ...
            _adapterFactory = channelFactory;
        ...
        private async Task<TResponsePacket> SendAndReceiveAsync<TResponsePacket>(MqttBasePacket requestPacket, CancellationToken cancellationToken) where TResponsePacket : MqttBasePacket
        {
            ...
            var packetWithIdentifier = requestPacket as IMqttPacketWithIdentifier;

            if (requestPacket is IMqttPacketWithIdentifier && packetWithIdentifier.PacketIdentifier.HasValue)
            {
