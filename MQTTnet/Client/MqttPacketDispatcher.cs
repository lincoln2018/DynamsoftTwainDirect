...
namespace MQTTnet.Client
{
    public class MqttPacketDispatcher
    {
        ...
        public void Dispatch(MqttBasePacket packet)
        {
            ...
            ushort identifier = 0;
            var packetWithIdentifier = packet as IMqttPacketWithIdentifier;
            if (packet is IMqttPacketWithIdentifier  && packetWithIdentifier.PacketIdentifier.HasValue)
            {
            ...
            TaskCompletionSource<MqttBasePacket> awaiter;
            if (_awaiters.TryRemove(key, out  awaiter))
            {
        ...
        public void RemovePacketAwaiter<TResponsePacket>(ushort? identifier) where TResponsePacket : MqttBasePacket
        {
            ...
            TaskCompletionSource<MqttBasePacket> _;
