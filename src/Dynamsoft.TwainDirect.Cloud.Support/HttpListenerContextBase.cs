...
namespace Dynamsoft.TwainDirect.Cloud.Support
{
    ...
    public class HttpListenerResponseBase : IDisposable
    {
        ...
        /// Handle TWAIN Local...
        /// </summary>
        /// <param name="a_httplistenerresponseLocal"></param>
        ...
        {
            if (m_devicesessionCloud != null && !string.IsNullOrEmpty(fileName) && File.Exists(fileName))
            {
        ...
        private async Task<bool> WriteCloudResponseAsync(string a_szResponse, string m_szThumbnailFile, string m_szImageFile)
        {
            ...
            if (imageBlockId != null || thumbnailBlockId != null)
            {
                ...
                a_szResponse = JsonConvert.SerializeObject(jsonObject, Formatting.None, JsonSettings);
            }
