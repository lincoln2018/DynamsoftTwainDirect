...
namespace Dynamsoft.TwainDirect.Cloud.Telemetry.Adapters
{
    /// <summary>
    /// Logger adapter for standard .NET TraceSource logger.
    /// </summary>
    /// <seealso cref="Dynamsoft.TwainDirect.Cloud.Telemetry.ILoggerAdapter" />
    public class TraceSourceLoggerAdapter : ILoggerAdapter
    {
        private static readonly TraceSource GlobalTranceSource = new TraceSource("Dynamsoft.TwainDirect.Cloud");
